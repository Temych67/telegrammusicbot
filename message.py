class Message:
    ...
    def success_downloaded() -> str:
        return '<strong>Процес завантаження аудіо файлу:</strong> \n ' \
               '✅ Завантаження файлу завершено. Відправляю вам 💿...'

    @staticmethod
    def success_sent() -> str:
        return 'Гарного прослуховування 😁'

    @staticmethod
    def sending_audio_error() -> str:
        return '🫣 Ой, щось пішло не так, не вдалось відправити даний аудіо файл.'
    ...
    @staticmethod
    def too_large_file() -> str:
        return f'😔 Вибачте але на разі я не можу вантажити файли розмір якого перевищує 50 MB.'
